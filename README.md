...
## 自 2025-05-05 起，由于《原神》官方不再提供 zip 形式的更新包体，对应的链接将停止更新，具体恢复时间待定。

## 自 2025-09-25 起，由于《崩坏 3》官方不再提供 zip 形式的更新包体，对应的链接将停止更新，具体恢复时间待定。
...
- 《崩坏：星穹铁道》
- 《绝区零》
- ~~《崩坏 3》~~（**由于不可抗力原因停止更新**，不过你可以尝试使用 [**Sophon Downloader**][sophon-downloader]）
